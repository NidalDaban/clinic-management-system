        ...
        <div class="doc-review review-listing">
            ...
            <ul class="comments-list">
                ...
                <li>
                    <div class="comment">
                        <img class="avatar rounded-circle" alt="User Image"
                            src="{{ asset('doctorDashboard/assets/') }}/img/patients/patient.jpg">
                    ...
                    <ul class="comments-reply">
                        ...
                        <li>
                            <div class="comment">
                                <img class="avatar rounded-circle" alt="User Image"
                                    src="{{ asset('doctorDashboard/assets/') }}/img/doctors/doctor-thumb-02.jpg">
                                <div class="comment-body">
                                    <div class="meta-data">
                ...
                <li>
                    <div class="comment">
                        <img class="avatar rounded-circle" alt="User Image"
                            src="{{ asset('doctorDashboard/assets/') }}/img/patients/patient2.jpg">
                        <div class="comment-body">
                            <div class="meta-data">
                ...
                <li>
                    <div class="comment">
                        <img class="avatar rounded-circle" alt="User Image"
                            src="{{ asset('doctorDashboard/assets/') }}/img/patients/patient3.jpg">
                        <div class="comment-body">
                            <div class="meta-data">
                ...
                <li>
                    <div class="comment">
                        <img class="avatar rounded-circle" alt="User Image"
                            src="{{ asset('doctorDashboard/assets/') }}/img/patients/patient4.jpg">
                        <div class="comment-body">
                            <div class="meta-data">
                ...
                <li>
                    <div class="comment">
                        <img class="avatar rounded-circle" alt="User Image"
                            src="{{ asset('doctorDashboard/assets/') }}/img/patients/patient5.jpg">
                        <div class="comment-body">
                            <div class="meta-data">
                ...
                <li>
                    <div class="comment">
                        <img class="avatar rounded-circle" alt="User Image"
                            src="{{ asset('doctorDashboard/assets/') }}/img/patients/patient9.jpg">
                        <div class="comment-body">
                            <div class="meta-data">
                ...
                <li>
                    <div class="comment">
                        <img class="avatar rounded-circle" alt="User Image"
                            src="{{ asset('doctorDashboard/assets/') }}/img/patients/patient8.jpg">
                        <div class="comment-body">
                            <div class="meta-data">
