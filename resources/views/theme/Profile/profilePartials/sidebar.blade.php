<div class="col-md-3 pt-0">
    <div class="list-group list-group-flush account-settings-links">
        ...
        {{-- <a class="list-group-item list-group-item-action" data-toggle="list" href="{{ route('theme.index') }}">Back to Home</a> --}}
        <a class="list-group-item list-group-item-action" href="{{ route('theme.index') }}">Back to Home</a>
